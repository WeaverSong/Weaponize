execute as @s[nbt={Inventory:[{Slot:-106b,tag:{wooden:1b}}]}] run function wpz:boomerangs/throw/wooden
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{stone:1b}}]}] run function wpz:boomerangs/throw/stone
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{iron:1b}}]}] run function wpz:boomerangs/throw/iron
