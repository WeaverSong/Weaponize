summon armor_stand ~ ~-0.2 ~ {NoGravity:1b,Invisible:1b,Invulnerable:1b,Marker:1b,Tags:["boomerang","iron","temp"],ArmorItems:[{},{},{},{id:"minecraft:fermented_spider_eye",Count:1b,tag:{CustomModelData:103,boomerang:1b,iron:1b}}]}
...
scoreboard players set @e[type=armor_stand,tag=temp] wpz-outtime 15
scoreboard players set @e[type=armor_stand,tag=temp] wpz-lifetime 200
scoreboard players set @e[type=armor_stand,tag=temp] wpz-damage 5000
